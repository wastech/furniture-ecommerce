	                            ...
	                            <tr>
	                                ...
	                                <td class="product-count">
	                                    <form action="#" class="count-inlineflex">
										    <div class="qtyminus" @click="action('min',item)">-</div>
										    <input type="text" name="quantity" :value="item.qty" class="qty">
										    <div class="qtyplus"  @click="action('add',item)">+</div>
										</form>
	                                </td>
	                                <td>
	                                    <div class="total">
			            ...
			            <form action="#" method="get" accept-charset="utf-8">
                           ...
                           <tr class="total-row">
			                ...
			                <div class="btn-cart-totals">
			                    ...
			                    <a href="#" class="checkout round-black-btn" title="" @click="checkout">Proceed to Checkout</a>
			                </div>
			                <!-- /.btn-cart-totals -->
			            </form>
			            <!-- /form -->
